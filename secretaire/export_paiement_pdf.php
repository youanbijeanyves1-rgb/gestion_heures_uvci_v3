...
<div class="infos">
    ...
    <strong>Règle niveau :</strong> L1, L2, L3 utilisent le taux LICENCE ; M1, M2 utilisent le taux MASTER.<br>
    <strong>Règle paiement :</strong> Vacataire = tout le volume validé est payable ; Permanent = les heures complémentaires sont calculées globalement puis réparties proportionnellement entre les niveaux.
</div>
';
    ...
    <tbody>
        ...
        <?php if(count($donnees) > 0): ?>
            ...
            <?php foreach($donnees as $d): ?>
                ...
                $volumeGlobalEnseignant = (float)$totauxParEnseignant[$id]["volume_total"];
                $chargeStatutaire = (float)$totauxParEnseignant[$id]["charge_statutaire"];
                ...
                if($d["statut"] === "VACATAIRE"){
                    ...
                    $heuresComplementairesGlobales = max(0, $volumeGlobalEnseignant - $chargeStatutaire);

                    if($volumeGlobalEnseignant > 0){
                        $proportion = $volumeValide / $volumeGlobalEnseignant;
                ...
                <tr>
                    ...
                    <td class="right"><?= number_format($volumeGlobalEnseignant, 2, ",", " ") ?> h</td>
